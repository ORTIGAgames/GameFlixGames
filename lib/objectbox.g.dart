...
final _entities = <ModelEntity>[
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 9210454794558896159),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 374783903673386535),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
  ...
  ModelEntity(
      id: const IdUid(2, 4804931489440004180),
      name: 'Task',
      lastPropertyId: const IdUid(4, 2278695090693262514),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 9075688364047256009),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 6662610650965015628),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 6620822507636650215),
            name: 'completed',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2278695090693262514),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 495653107105463730),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 4804931489440004180),
      lastIndexId: const IdUid(1, 495653107105463730),
